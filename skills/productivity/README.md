# productivity/ — promoted skills

Skills for managing conversations, handoffs, and decisions. This is a promoted bucket: everything here ships in `plugin.json`, the README/CLAUDE.md tables, and `lcc install`.
