...
function main() {
  ...
  // README/CLAUDE.md. Its count string and numeric `features` fields are
  // regenerated by parsing, editing in place, and re-serializing instead,
  // through the same diffOrWrite drift mechanism as every other target.
